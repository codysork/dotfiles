...
I also created a [public branch](https://github.com/codysork/dotfiles/blob/public) of this repo with fewer personalized features in it, so that it's better suited for general public use.
